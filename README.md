...
![MCP tools](https://img.shields.io/badge/MCP%20tools-143-4C5BD4.svg)
...
PromptWise core  (router · roles · compliance · context engine · workflow_planner)
        ├─▶ MCP tools      → route_request, plan_workflow, owasp_scan …  (143)
...
accurate ledger); 143 MCP tools, 83 portable skill packs, 1638 tests, registered
