...
![MCP tools](https://img.shields.io/badge/MCP%20tools-135-4C5BD4.svg)
...
PromptWise core  (router · roles · compliance · context engine · workflow_planner)
        ├─▶ MCP tools      → route_request, plan_workflow, owasp_scan …  (135)
...
accurate ledger); 135 MCP tools, 81 portable skill packs, ~1301 tests, registered
