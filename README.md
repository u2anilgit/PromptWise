...
agile method, runtime enforcement hooks, and 77 portable skill packs — emitted in the formats every agent already reads.
...
![Skill packs](https://img.shields.io/badge/skill%20packs-77-7C5BD4.svg)
...
- **Role intelligence** — 77 role/technique skill packs (banking, HIPAA, QA, TDD, ADR, …).
...
PromptWise core  (router · roles · compliance · context engine · workflow_planner)
        ...
        ├─▶ SKILL.md packs → 77 portable packs in skill_packs/
...
| `skill_packs/` | 77 portable `SKILL.md` role/technique packs (incl. `agile/` personas; copy into any agent) |
...
**Early-stage, building in public.** v1.2 ships the engine, the five emitters, the 77
