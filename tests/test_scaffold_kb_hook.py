...
from promptwise.core import scaffold as scaffold_mod


def test_kb_disabled_by_default_no_note(tmp_path, monkeypatch):
...
def test_kb_enabled_with_trusted_match_adds_note(tmp_path, monkeypatch):
