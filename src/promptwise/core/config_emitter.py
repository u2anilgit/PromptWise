...
# Detector / profile keys that aren't 1:1 with an emitter key yet. Codex and
# Gemini both read AGENTS.md, so they map onto the shared canonical target.
_TARGET_ALIASES = {"codex": "agents", "gemini": "agents"}
