...
# kb_lookup/list_kb_entries/review_kb_candidates/promote_kb_candidates
...
async def call_tool(ctx: ServerContext, name: str, arguments: dict) -> str:
    ...
    remote_identity = get_current_remote_identity()
    if remote_identity is not None:
        from promptwise.dashboard.auth import role_satisfies
...
from promptwise.handlers.security import _handle_security_check, _handle_prompt_injection, _handle_owasp_scan, _handle_scan_response, _handle_benchmark_injection, _handle_accept_risk, _handle_list_risk_register, _handle_review_corpus_candidates, _handle_promote_corpus_candidates  # noqa: F401
